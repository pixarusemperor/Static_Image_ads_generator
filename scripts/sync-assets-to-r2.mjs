...
if (!accountId || !accessKeyId || !secretAccessKey || !bucketName) {
  ...
  console.error('Please configure R2_ACCOUNT_ID, R2_ACCESS_KEY_ID, R2_SECRET_ACCESS_KEY, and R2_BUCKET_NAME.');
  process.exit(1);
}
...
async function main() {
  ...
  console.log('✓ All assets successfully synchronized to Cloudflare R2!');
}
